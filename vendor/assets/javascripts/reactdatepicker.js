    ...
    if (this.state.calendarIcon == 'false'){
      return React.createElement("div", {className: "ardp-date-picker"},
        React.createElement("div", {className: "clear-text-wrap-note"},
         React.createElement("input", {ref: "trigger", type: "text", className: this.state.dateClass + " date-picker-trigger-" + this.state.id, readOnly: true, value: (this.state.manualInput || DateUtilities.toString(this.state.selected)), onClick: this.show, onChange: this.onManualInput, onBlur: this.onManualInputBlur})),
